...
# @override_settings(
#     ROOT_URLCONF='user_management.urls',  # Replace 'your_project' with your actual project name
#     REST_FRAMEWORK={
...
#         # Mock timezone.now() to return a time after the lockout period
...
#         self.assertEqual(settings.max_attempts, 5)  # Default value
#         self.assertEqual(settings.lockout_duration, 30)  # Default value
